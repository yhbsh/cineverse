...
String _$favoriteReposioryHash() => r'2cbc269f6e577df42a792d5a8c9dba8ea825c3a2';

/// See also [favoriteReposiory].
@ProviderFor(favoriteReposiory)
final favoriteReposioryProvider =
    AutoDisposeProvider<IFavoriteRepository>.internal(
  favoriteReposiory,
  name: r'favoriteReposioryProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$favoriteReposioryHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
